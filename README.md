...
| `GET` | `/batchstock/days=1600&sectorId=1&category=CONGELADOS` | Obtenha uma lista de lotes dentro do prazo de validade solicitado, que pertencem a uma determinada categoria de produto (FRESCOS, REFRIGERADO, CONGELADO)|-- |
